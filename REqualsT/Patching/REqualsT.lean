import REqualsT.Patching.System
...
variable [TopologicalSpace Λ] [TopologicalRing Λ] [CompactSpace Λ] [IsAdicTopology Λ]
...
variable [TopologicalSpace R₀] [TopologicalRing R₀] [CompactSpace R₀] [IsAdicTopology R₀]
